						...
						<table class="tableOne">
							...
							<tr>
								...
								<td>
									<div id="seniorDiv">
										<div class="form-group">
											<input id="seniorID" type="text" placeholder="Senior Citizen ID Number" autocomplete="off" value="senior">
										</div>
									</div>
									<div class="d-none" id="pwdDiv">
										<div class="form-group">
											<input id="pwdID" type="text" placeholder="PWD ID Number" autocomplete="off" value="pwd">
										</div>
									</div>
								</td>
							</tr>
