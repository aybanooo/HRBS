...
<head>
    ...
    <!--<script src="https://use.fontawesome.com/releases/v5.15.1/js/all.js" crossorigin="anonymous"></script> Inalis ko muna to para di magconflict sa fa inimport ko galing sa admin-->
...
<body>
    ...
    <?php
        $query="SELECT roomName, roomDesc FROM roomtype WHERE roomtypeID='29';";
        $result=mysqli_query($conn, $query) or die(mysqli_error($conn));
        $followingdata = $result->fetch_array(MYSQLI_ASSOC);
    ?>
			...
			<div class="card-header d-flex p-0">
			  <div class="container-fluid ce-noblank ce-noenter">
			  	<div class="row">
					...
					<div class="col-lg-4 mx-auto">
						<a href="Customer-Booking_Form.html"><button type="button" class="btn btn-success">Book Now</button></a>
					</div>
				</div>
			  </div>  
			</div><!-- /.card-header -->
			  ...
			  <div class="row">
				<div class="col">
				  <div class="card mb-2 bg-gradient-dark roomImageCard">
					<img class="card-img-top" src="https://cdn.geekwire.com/wp-content/uploads/2017/10/170923-002-1260x840.jpg" alt="Dist Photo 1">
						...
						<div class="tab-pane fade" id="roomSection-living_room" role="tabpanel" aria-labelledby="roomSection-living_room-tab">
						  <div class="container-fluid p-3">
							...
							<div class="row mx-1 mx-sm-5 my-sm-2">
							  <div class="col-12 ce-limit ce-noenter ce-blankremove">
								<ul class="list-unstyled row gen-info-list">
								  <li class="list-item col-6 col-md-3"><i class="fas fa-check mx-1"></i><span>Carpeted Floor</span></li>
								  <li class="list-item col-6 col-md-3"><i class="fas fa-check mx-1"></i><span>55' 4k TV</span></li>
								  <li class="list-item col-6 col-md-3"><i class="fas fa-check mx-1"></i><span>Sofabed</span></li>
