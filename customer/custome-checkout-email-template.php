...
<body style="margin: 0; background-color: #283C4B; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
							...
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0"
										...
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #283C4B; color: #000000;"
										width="600">
										<tbody>
											<tr>
												<th class="column" width="100%"
													...
													<table class="image_block" width="100%" border="0" cellpadding="25"
														cellspacing="0" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td>
																<div align="center" style="line-height:10px"><img
																		src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/730351_713407/logo.png"
																		style="display: block; height: auto; border: 0; width: 120px; max-width: 100%;"
																		width="120" alt="Image" title="Image"></div>
															</td>
														</tr>
													</table>
												</th>
						...
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0"
										cellspacing="0" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #3AAEE0; color: #333;"
										width="600">
										<tbody>
											<tr>
												<th class="column" width="100%"
											...
											<tr>
												<th class="column" width="100%"
																	...
																	<div
																		...
																		<p
																			...
																			<span style="font-size:16px;"><span
																						style="font-size:16px;">Thank you for visiting us at <?php echo $followingdata['companyName']; ?>. I hope we achieved our goal of making your stay memorable by providing outstanding service.</span></span>
																		</p>
																		<p
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;"><span
																						style="font-size:16px;">We strive to make the experience at <?php echo $followingdata['companyName']; ?> one you will remember forever. Therefore, your comments are very important to us.</span></span>
																		</p>
																		<p
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;"><strong><span
																						style="font-size:16px;">Please take a moment of your time to complete our Online <!--Insert link to review section here-->, so we maintain our exceptional service.</span></span>
																		</p>
																		<p
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;"><span
																						style="font-size:16px;">We Love to hear your feedback and use it to review and improve our services every day!<br>Looking forward to welcoming you again soon.</span></span>
																		</p>
																	</div>
																</div>
															</td>
													...
													<table class="text_block" width="100%" border="0" cellpadding="0"
														...
														<tr>
															<td
																style="padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #283C4B; line-height: 1.5;">
																		<p
																		...
																		<p
																			style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 21px;">
																			<span style="font-size:14px;">GHRBS
																				team</span></p>
																	</div>
																</div>
															</td>
													...
													<table class="text_block" width="100%" border="0" cellpadding="0"
														...
														<tr>
															<td style="padding-bottom:10px;padding-top:30px;">
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #3AAEE0; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 12px; text-align: center;">
																			<span style="font-size:18px;">OUR STUNNING
																				AMMENITIES</span></p>
																	</div>
																</div>
															</td>
																		...
																		<td
																			...
																			<div align="center"
																				style="line-height:10px"><img
																					src="https://d15k2d11r6t6rl.cloudfront.net/public/users/BeeFree/beefree-ho1qu5xpme/editor_images/royal%20suite.jpg"
																			...
																			<div style="font-family: sans-serif">
																				<div
																					...
																					<p
																						...
																						<strong><span
																								style="font-size:16px;">Soak
																								up the sun and the views
																								in stunning
																								Santorini</span></strong>
																					</p>
																				</div>
																			</div>
																		</td>
																		...
																		<td>
																			<div style="font-family: sans-serif">
																				<div
																					...
																					<p
																						style="margin: 0; font-size: 14px;">
																						The Standard Room comprises of 1
																						Double Bed or 2 Twin Beds, 2
																						Bedside Tables, a Desk &amp;
																						Chair. The room is furnished
																						with wall to wall carpeting,
																						trendy furnishings and a
																						balcony. Our ultramodern glass
																						bathroom is equipped with
																						hairdryer, magnifying shaving
																						and make up mirror as well as
																						all the amenities you could
																				...
																				style="text-decoration:none;display:inline-block;color:#FFFFFF;background-color:#3AAEE0;border-radius:4px;width:auto;border-top:1px solid #3AAEE0;border-right:1px solid #3AAEE0;border-bottom:1px solid #3AAEE0;border-left:1px solid #3AAEE0;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
																					style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span
																						style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
																							...
																							data-mce-style="font-size: 14px; line-height: 28px;">FIND
																							OUT
																							MORE</span><br></span></span></a>
																...
																<table class="image_block" width="100%" border="0"
																	...
																	<tr>
																		<td
																			...
																			<div align="center"
																				style="line-height:10px"><img
																					src="https://d15k2d11r6t6rl.cloudfront.net/public/users/BeeFree/beefree-ho1qu5xpme/editor_images/pool.jpg"
																					style="display: block; height: auto; border: 0; width: 260px; max-width: 100%;"
																					width="260" alt="Image"
																					title="Image"></div>
																		</td>
																					...
																					<p
																						...
																						<strong><span
																								style="font-size:16px;"><span
																									style="font-size:16px;">Luxury
																									Hotels in Maldives:
																									ditch your shoes and
																									pinch
																									yourself</span></span></strong>
																					</p>
																				</div>
																			</div>
																		</td>
																		...
																		<td>
																			<div style="font-family: sans-serif">
																				<div
																					...
																					<p
																						style="margin: 0; font-size: 14px;">
																						GHRBS’s swimming pool has a
																						perfect ventilation system,
																						strict water quality control,
																						and natural lighting that
																						ensures a relaxing
																						atmosphere.<br><br>Enjoy
																						swimming at GHRBS indoor pool
								...
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0"
										...
										<tbody>
											<tr>
												<th class="column" width="100%"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 30px; padding-bottom: 10px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="social_block" width="100%" border="0" cellpadding="0"
														cellspacing="0" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td
																style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;text-align:right;">
																<table class="social-table" width="208px" border="0"
																	...
																	<tr>
																		...
																		<td style="padding:0 0 0 20px;"><a
																				href="https://twitter.com/joshuamilante_?fbclid=iwar1zogtckvpmjui_z8nl1-3wrwo5f_ufdtjldzmc275lllo8k2el1yoqbek"
																				target="_blank"><img
																		...
																		<td style="padding:0 0 0 20px;"><a
																				href="https://www.instagram.com/joshuamilante_/?fbclid=iwar3vfrgw3fdk_xfwfidtku9hr8akagybvwzbtddenc6wt8-bqvq0dzkkbjg"
																				target="_blank"><img
																		...
																		<td style="padding:0 0 0 20px;"><a
																				href="https://www.instagram.com/joshuamilante_/?fbclid=iwar3vfrgw3fdk_xfwfidtku9hr8akagybvwzbtddenc6wt8-bqvq0dzkkbjg"
																				target="_blank"><img
																					src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/instagram.png"
																					width="32" height="32"
